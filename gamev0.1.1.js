...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.matter.world.on('collisionactive', function (event, bodyA, bodyB) {
            ...
            this.gameOver = this.add.image(700, 150, 'gameOver');
            ...
            this.tutorialText2 = this.add.text(16, 16, 'Use space to attack!', { fontSize: '32px', fill: '#FFFFFF' });
    ...
    update() {
        ...
        if (this.cursors.right.isDown) {
            ...
            this.tutorialText2.visible = true;
        ...
        if (this.cursors.space.isDown)
        {
            ...
            this.tutorialText2.visible = false;
            this.tutorialText2 = this.add.text(16, 16, '', { fontSize: '32px', fill: '#FFFFFF' });
